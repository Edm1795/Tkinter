...
class MainWindow:
    def __init__(self, master):
        ...
        self.speedometerDict = {'Blue Pens':[[1,1],[1,2],501],'Staedtler Pens':[[1,3],[1,4],411],'China Markers':[[1,5],[1,6],401],'Red Pens':[[1,7],[1,8],578],'Paper Clips':[[1,9],[1,10],320],'White Tape':[[1,11],[1,12],501],'Golf Pencils':[[1,13],[1,14],401],'Scissors':[[2,1],[2,2],421],'Transparent Name Tag Slips (Small)':[[2,3],[2,4],579]}
    ...
    def calcSpeed(self):
        ...
        self.speedometerDict['Blue Pens'][2]=speedOfItem
