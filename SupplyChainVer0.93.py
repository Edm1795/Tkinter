...
class MainWindow:
    def __init__(self, master):
        ...
        # Master Window
        self.master = master
        self.master.title('Supply Chain Ver. 0.94')
        ...
        # list of all speedometer's and item names. Structure:  #  {itemNameAsKey: Value as list of lists [[values for drawCircle() label row and col...],[values for updateSpeedometer() circle row and col...],Quantity of Item]} 579 = full stock
