...
class MainWindow:
    def __init__(self, master):
        ...
        # list of all speedometer's and item names. Structure:  #  {itemNameAsKey: Value as list of lists [[values for drawCircle() label row and col...],[values for updateSpeedometer() circle row and col...]]}
    ...
    def drawCircle(self,itemName, LabRowCol,cirRowCol):
        """ This method creates the speedometers and labels (item name) for each item in stock.
        ...
        editButton = Button(c, text='Edit')  # create button on the canvas
