...
class MainWindow:
    def __init__(self, master):
        ...
        # Master Window
        self.master = master
        self.master.title('Supply Chain Ver. 0.2')
    ...
    def addItem(self, LabRowCol, cirRowCol,itemName):  # adds stock items to the screen
        ...
        self.speedometerDict.update({itemName: self.drawCircle(10, 10, 80, 80,3,[1,1],[1,2], 'Black Pens')})
        ...
        self.speedometerDict.update({itemName: self.drawCircle(10, 10, 80, 80, 3,LabRowCol,cirRowCol, itemName)})
