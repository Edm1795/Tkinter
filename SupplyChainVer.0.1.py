...
class MainWindow:
    def __init__(self, master):
        ...
        # Master Window
        self.master = master
        self.master.title('Supply Chain Ver. 0.1')
        ...
        self.speedometerList = []  # list of all speedometer's and item names

        self.circleOrigin = self.calcCircleOrigin(10, 10, 80, 80)  # self.circleOrigin: a list of speedometer's values: [xOrigin, yOrigin, radius]
    ...
    def addItem(self, LabRowCol, cirRowCol,itemName):  # adds stock items to the screen
        ...
        self.speedometerList.append(self.drawCircle(10, 10, 80, 80,3,[1,1],[1,2], 'Black Pens'))
        self.speedometerList.append(self.drawCircle(10, 10, 80, 80,3,[1,3],[1,4], 'China Markers'))
        self.speedometerList.append(self.drawCircle(10, 10, 80, 80,3,[1,5],[1,6], 'Red Pens'))
        self.speedometerList.append(self.drawCircle(10, 10, 80, 80,3,[1,7],[1,8], 'Golf Pencils'))

        self.speedometerList.append(self.drawCircle(10, 10, 80, 80, 3,LabRowCol,cirRowCol, itemName))
