...
class MainWindow:
    ...
    def __init__(self, master):
        ...
        # Master Window
        self.master = master
        self.master.title('Supply V. 0.996')
...
class Item:
    ...
    """
    This is a class for items in inventory. It is initialized with most of the neccessary values needed by each item.
...
def addItem():
    ...
    stockTypeEntry.bind('<Return>', lambda event: combineAddItemAndMaxStock())
...
def editItem(itemName):
    ...
    editItemEntry.bind('<Return>', lambda event: updateQuantityInSpeedometerDict(itemName,item)) # send the itemName to the updateQuantity function

    def updateQuantityInSpeedometerDict(nameOfStock,item):
        """
